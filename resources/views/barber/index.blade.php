            ...
            <div class="card-body">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header border-0">
                                <h5 class="modal-title"><span class="fw-mediumbold">เพิ่มข้อมูลการบริการและราคา</span></h5>
                                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">×</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form id="addForm" action="{{ route('barber.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="NameInput" class="form-label">ชื่อ</label>
                                                <input id="NameInput" name="name" type="text" class="form-control" placeholder="กรอกชื่อบริการ" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="PhoneInput" class="form-label">phone</label>
                                                <input id="PhoneInput" name="phone" type="text" class="form-control" placeholder="กรอกเบอร์โทร" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="EmailInput" name="email" type="email" class="form-control" placeholder="กรอกอีเมล์" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="PasswordInput" class="form-label">Password</label>
                                                <input id="PasswordInput" name="password" type="password" class="form-control" placeholder="กรอกรหัสผ่าน" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="ImageInput">รูปภาพ</label>
                ...
                <div class="modal fade" id="editRowModal" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header border-0">
                                <h5 class="modal-title"><span class="fw-mediumbold">แก้ไขข้อมูลพนักงาน</span></h5>
                                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">×</span>
                                </button>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input id="editName" name="name" type="text" class="form-control" placeholder="กรอกชื่อบริการ" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="editPhone" class="form-label">phone</label>
                                                <input id="editPhone" name="phone" type="text" class="form-control" placeholder="กรอกเบอร์โทร" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="editEmail" class="form-label">อีเมล์</label>
                                                <input id="editEmail" name="email" type="email" class="form-control" placeholder="กรอกอีเมล์" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="editImage" class="form-label">รูปภาพ</label>
                                                <input id="editImage" name="image" type="file" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </form>
                            ...
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ url('/barber/' . $user->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('คุณต้องการลบข้อมูลนี้หรือไม่ ?')">
                                            @csrf
                                            @method('DELETE')
